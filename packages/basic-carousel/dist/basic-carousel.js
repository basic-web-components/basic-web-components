    ...
    _createClass(SingleSelection, [{
      ...
      set: function set(index) {
        ...
        if (index !== this[externalSelectedIndexSymbol]) {
          ...
          this[externalSelectedIndexSymbol] = hasItems && index >= 0 && index < items.length ? index : -1;
