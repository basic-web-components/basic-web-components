...
},{"./Collective":3,"./createSymbol":21,"./safeAttributes":23,"./symbols":24}],11:[function(require,module,exports){
'use strict';
...
exports.default = function (base) {
   ...
   */
  var SelectedItemTextAsValue = function (_base) {
    _inherits(SelectedItemTextAsValue, _base);

    function SelectedItemTextAsValue() {
      _classCallCheck(this, SelectedItemTextAsValue);

      return _possibleConstructorReturn(this, (SelectedItemTextAsValue.__proto__ || Object.getPrototypeOf(SelectedItemTextAsValue)).apply(this, arguments));
    }

    _createClass(SelectedItemTextAsValue, [{
      key: 'value',
...
},{"../../basic-component-mixins/src/AttributeMarshalling":1,"../../basic-component-mixins/src/Composable":4,"../../basic-component-mixins/src/DistributedChildren":7,"../../basic-component-mixins/src/ShadowElementReferences":18,"../../basic-component-mixins/src/ShadowTemplate":19}],27:[function(require,module,exports){
'use strict';
