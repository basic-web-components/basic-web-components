...
exports.default = function (base) {
  ...
  var TabStrip = function (_base) {
    ...
    function TabStrip() {
      ...
      _this.$.tabStrip.addEventListener('selected-item-changed', function () {
...
},{"../../basic-component-mixins/src/symbols":41}],68:[function(require,module,exports){
'use strict';
