...
var ArrayToList = function (_ElementBase) {
  _inherits(ArrayToList, _ElementBase);

  function ArrayToList() {
    _classCallCheck(this, ArrayToList);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ArrayToList).apply(this, arguments));
  }

  _createClass(ArrayToList, [{
    ...
    key: 'renderItemAsElement',
    value: function renderItemAsElement(item, element) {}
  }, {
    key: 'renderItems',
    value: function renderItems() {
      ...
      this.items.forEach(function (item) {
        var element = _this2.createElementForItem(item);
...
},{"../../basic-element-base/src/ElementBase":7}],2:[function(require,module,exports){
"use strict";
