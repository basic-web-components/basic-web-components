...
children distributed to the component.
  ...
  **Kind**: instance property of <code>[PlayControls](#PlayControls)</code>. Defined by <code>[DistributedChildrenContent](../basic-component-mixins/docs/DistributedChildrenContent.md)</code> mixin.
...
children) have changed.
  ...
  **Kind**: event emitted by <code>[PlayControls](#PlayControls)</code>. Defined by <code>[DistributedChildrenContent](../basic-component-mixins/docs/DistributedChildrenContent.md)</code> mixin.
...
component to perform initial processing of its children.
  ...
  **Kind**: instance method of <code>[PlayControls](#PlayControls)</code>. Defined by <code>[DistributedChildrenContent](../basic-component-mixins/docs/DistributedChildrenContent.md)</code> mixin.
...
### playControls.selectedFraction : <code>number</code>
