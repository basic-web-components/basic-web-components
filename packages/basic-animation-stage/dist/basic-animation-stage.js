...
function initialPositions(element) {
  ...
  element.items.forEach(function (item, index) {
    var fraction = index === selectedIndex ? 0.5 : // Selected item shown halfway through animation: center stage.
    index > selectedIndex ? 0 : // Offstage next
    1; // Offstage previous
