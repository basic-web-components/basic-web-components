...
var AnimationStage = function (_base) {
  ...
  _createClass(AnimationStage, [{
    ...
    value: function animateItem(item, animation, delay) {
      var duration = (animation.length - 1) * this.animationDuration;
    ...
    get: function get() {
      var forward = {
        cross: [{ opacity: 0.8, transform: 'translateX(100%)' }, { opacity: 1.0, transform: 'translateX(0)' }, { opacity: 1.0, transform: 'translateX(-100%)' }],
        enter: [{ opacity: 0.8, transform: 'translateX(100%)' }, { opacity: 1.0, transform: 'translateX(0)' }],
        exit: [{ opacity: 1.0, transform: 'translateX(0)' }, { opacity: 0.8, transform: 'translateX(-100%)' }]
      };
      var backward = {
