  ...
  var SelectionAnimation = function (_base) {
    ...
    _createClass(SelectionAnimation, [{
      ...
      value: function animateSelection(fromIndex, toIndex) {
        ...
        var startDelay = fromFraction === 0 ? 0 : -Math.abs(fromFraction) * duration / 2;
        ...
        for (var i = 0; i < itemCount; i++) {
          ...
          if (i < animateCount) {
            ...
            var player = this.animateItem(item, animation, duration, delay, endDelay);
            if (i === animateCount - 1) {
              (function () {
