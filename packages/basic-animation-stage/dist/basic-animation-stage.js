    ...
    _createClass(SelectionAnimation, [{
      ...
      value: function resetItemPositions() {
        ...
        this.items.forEach(function (item, index) {
          ...
          1; // Offstage previous
          setPlayerFraction(_this2, index, fraction);
        });
      }
    }, {
      key: 'showTransition',
      ...
      key: 'snapSelection',
      value: function snapSelection(toIndex) {
        var position = this.position;
        var indexBase = toIndex + Math.trunc(position);
