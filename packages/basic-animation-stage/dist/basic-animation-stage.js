  ...
  var SelectionAnimation = function (_base) {
    ...
    _createClass(SelectionAnimation, [{
      ...
      value: function _effectTimingsForSelectionAnimation(fromIndex, toIndex) {
        ...
        var fill = 'both';
        var totalDuration = this.selectionAnimationDuration;
      ...
      value: function _animationFractionsAtSelectionIndex(selectionIndex) {
        ...
        return items.map(function (item, itemIndex) {
          ...
          if (oneStepOrLessAway && (selectionWraps || isItemIndexInBounds(_this3, selectionIndex + steps))) {
            // We want:
...
function displayNextItemWhenAnimationCompletes(element, animationDetails, toIndex) {
  ...
  element._lastSelectionAnimation.onfinish = function (event) {
