    ...
    _createClass(SelectionAnimation, [{
      ...
      value: function animateSelection(fromIndex, toIndex) {
        ...
        this.items.forEach(function (item, itemIndex) {
          ...
          var timing = _this2._itemAnimationEffectTimingToSelectionIndex(itemIndex, toIndex);
          // if (animateItem) {
          if (timing) {
            showItem(item, true);
            ...
            timing.endDelay = itemIndex === wholeTo ? -duration / 2 : // Stop halfway through.
            0; // Play animation until end.

            _this2._animations[itemIndex] = item.animate(keyframes, timing);
      ...
      key: '_animationEffectTimingsForAnimations',
      value: function _animationEffectTimingsForAnimations(itemIndex, fromIndex, toIndex) {}
    }, {
      key: 'update',
