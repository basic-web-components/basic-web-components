    ...
    _createClass(SelectionAnimation, [{
      ...
      value: function animateSelection(fromIndex, toIndex) {
        ...
        for (var i = 0; i < itemCount; i++) {
          var animateItem = i < animateCount && (isIndexInBounds(this, itemIndex) || selectionWraps);
          ...
          if (animateItem) {
            ...
            if (i === animateCount - 1) {
              (function () {
                ...
                var nextUpIndex = itemIndex + indexStep;
                if (isIndexInBounds(_this2, nextUpIndex) || selectionWraps) {
                  (function () {
      ...
      value: function showSelection(toIndex) {
        ...
        items.forEach(function (item, itemIndex) {
          var steps = stepsToIndex(itemCount, true, wholeTo, itemIndex);
          var isOneStepAway = Math.abs(steps - Math.round(toFraction)) <= 1;
          if (isOneStepAway && (selectionWraps || isIndexInBounds(_this3, toIndex + steps))) {
            showItem(item, true);
            // We want
