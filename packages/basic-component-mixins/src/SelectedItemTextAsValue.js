...
export default (base) => {
  ...
  /**
   * Mixin which defines a `value` property that reflects the text content of
   * a selected item.
   *
   ...
   * [ContentAsItems](ContentAsItems.md) mixin. This also expects the definition
   * of `selectedIndex` and `selectedItem` properties, which can be obtained
   * from the [SingleSelection](SingleSelection.md) mixin.
   */
