...
/*
 * Simple element using the DistributedChildrenContentMixin mixin.
 */
class ContentTest extends DistributedChildrenContentMixin(
...
describe("DistributedChildrenContentMixin", () => {
