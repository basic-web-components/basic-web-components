...
const fractions = SelectionAnimationMixin.helpers.animationFractionsForSelection;
const timings = SelectionAnimationMixin.helpers.effectTimingsForSelectionAnimation;


class SelectionAnimationTest extends SelectionAnimationMixin(HTMLElement) {
...
describe("SelectionAnimationMixin", () => {
